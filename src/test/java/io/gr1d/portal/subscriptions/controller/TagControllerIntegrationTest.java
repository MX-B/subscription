...
public class TagControllerIntegrationTest {
    ...
    public void testTagCreation() throws Exception {
        final TagRequest request = Fixture.from(TagRequest.class).gimme("valid");
        final String uri = "/tag";
        ...
        final TagRequest anotherRequest = Fixture.from(TagRequest.class).gimme("valid");
    ...
    public void testNotFound() throws Exception {
        final String uri = "/tag/12y8e9129y8h";
    ...
    public void testValidationName() throws Exception {
        final TagRequest invalidName = Fixture.from(TagRequest.class).gimme("invalidName");
        final TagRequest invalidSlug = Fixture.from(TagRequest.class).gimme("invalidSlug");

        checkXss(mockMvc.perform(post("/tag")
                .contentType(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON)
